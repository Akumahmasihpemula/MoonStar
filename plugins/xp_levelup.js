...
*ᴘᴇsᴀɴ*
> ᴋᴀᴍᴜ ᴍᴇᴍʙᴜᴛᴜʜᴋᴀɴ*${max - user.exp}* xᴘ ᴜɴᴛᴜᴋ ɴᴀɪᴋ ᴋᴇ ʟᴇᴠᴇʟ sᴇʟᴀɴᴊᴜᴛɴʏᴀ`.trim()
  }
  let before = user.level * 1
	while (levelling.canLevelUp(user.level, user.exp, global.multiplier)) user.level++
	if (before !== user.level) {
            m.reply(`[ sᴀʀᴀᴛ ᴅɪ ᴘᴇɴᴜʜɪ ]

ɴᴀᴍᴇ: ${m.name}
ʟᴇᴠᴇʟ: *${user.level}*

ᴘᴇsᴀɴ
sᴇʟᴀᴍᴀᴛ ᴋᴀᴍᴜ ɴᴀɪᴋ ʟᴇᴠᴇʟ sᴇʙᴇʟᴜᴍɴʏᴀ *${before}* ᴅᴀɴ ɴᴀɪᴋ ᴋᴇ ʟᴇᴠᴇʟ *${user.level}*`.trim())
        }
}
