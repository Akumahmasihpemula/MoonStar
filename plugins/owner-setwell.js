...
global.setwelcome = text 
 if (text === "simple") {
m.reply(`\`sᴜᴋsᴇs ᴍᴇɴɢɢᴀɴᴛɪ ᴛʜᴇᴍᴀ ᴡᴇʟᴄᴏᴍᴇ ᴋᴇ sɪᴍᴘʟᴇ\``) 
 } else if (text === "image") {
 m.reply(`\`sᴜᴋsᴇs ᴍᴇɴɢɢᴀɴᴛɪ ᴛʜᴇᴍᴀ ᴡᴇʟᴄᴏᴍᴇ ᴋᴇ ɪᴍᴀɢᴇ\``)  
 } else if (text === "payment") {
  m.reply(`\`sᴜᴋsᴇs ᴍᴇɴɢɢᴀɴᴛɪ ᴛʜᴇᴍᴀ ᴡᴇʟᴄᴏᴍᴇ ᴋᴇ ᴘᴀʏᴍᴇɴᴛ\``) 
 } else if (text === "edit") {   
 m.reply(`\`sᴜᴋsᴇs ᴍᴇɴɢɢᴀɴᴛɪ ᴛʜᴇᴍᴀ ᴡᴇʟᴄᴏᴍᴇ ᴋᴇ ᴇᴅɪᴛ\``) 
 } else {
m.reply(`
[ DAFTAR THEMA ] 
...
ᴛʜᴇᴍᴀ ᴡᴇʟᴄᴏᴍᴇ ᴅɪ sᴇᴛᴜʟᴀɴɢ `) 
}
};
handler.help = ["setwell *[welcome set]*"];
handler.tags = ["owner"];
handler.command =  ["setwell"];
handler.rowner = true;
