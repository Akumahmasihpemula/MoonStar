const { xvideosdl } = require("../scrape/xvideos.js");
let handler = async (m, { conn, text, usedPrefix, command }) => {
if (!text) return m.reply(`Cara penggunaan\n\n*Contoh :* ${usedPrefix + command} https://www.xnxx.com/video-1c5mo342/1_girl_and_1_guy_fucking_eatch_other_hentai`) 

try {
const hasil = await xvideosdl(text)
const vid = hasil.url;
...
handler.help = ['xvideodl'];
handler.tags = ['dl'];
handler.command = /^(xvideodl|xvideodl)$/i;
