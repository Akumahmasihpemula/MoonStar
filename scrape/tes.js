...
const terabox = {
  getInfo: async function(inputUrl) {
    try {
  ...
  getDownloadLink: async function(fsId, shareid, uk, sign, timestamp) {
    try {
  ...
  download: async function(inputUrl) {
    try {
      ...
      return { status: true, Creator: nameown, data: array };
    } catch (error) {
      console.error("Gagal mengunduh file:", error);
      throw { status: false, Creator: nameown, data: error.message };
    }
  }
};
